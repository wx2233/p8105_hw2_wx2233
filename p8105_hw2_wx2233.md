...
``` r
Wheel_data = 
 readxl::read_excel("./data/HealthyHarborWaterWheelTotals2018-7-28.xlsx",sheet = "Mr. Trash Wheel", range = "A2:N338") %>%  #import data from sheet 1
...
```
    ...
    ## 2 2018   0.96  5.3   2.18  3.2   9.27   0.2  2.39 NA    NA       NA NA   
